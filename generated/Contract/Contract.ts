...
export class Contract__getActionsResult {
...
export class Contract__getReceiptResultValue0Struct extends ethereum.Tuple {
...
export class Contract extends ethereum.SmartContract {
  ...
  getActions(proposalId: BigInt): Contract__getActionsResult {
    let result = super.call(
      "getActions",
    ...
    return new Contract__getActionsResult(
  ...
  try_getActions(
    proposalId: BigInt
  ): ethereum.CallResult<Contract__getActionsResult> {
    let result = super.tryCall(
      "getActions",
      "getActions(uint256):(address[],uint256[],string[],bytes[])",
      [ethereum.Value.fromUnsignedBigInt(proposalId)]
    ...
    return ethereum.CallResult.fromValue(
      new Contract__getActionsResult(
  ...
  getReceipt(
    proposalId: BigInt,
    voter: Address
  ): Contract__getReceiptResultValue0Struct {
    let result = super.call(
      "getReceipt",
    ...
    return result[0].toTuple() as Contract__getReceiptResultValue0Struct;
  }

  try_getReceipt(
    proposalId: BigInt,
    voter: Address
  ): ethereum.CallResult<Contract__getReceiptResultValue0Struct> {
    let result = super.tryCall(
      "getReceipt",
      "getReceipt(uint256,address):((bool,bool,uint96))",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTuple() as Contract__getReceiptResultValue0Struct
    );
  }
